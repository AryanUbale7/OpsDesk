  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto px-8 py-6 space-y-6 min-w-0 bg-[#F6F6F6] font-sans selection:bg-[#ADFF41] selection:text-[#014D3E] text-slate-800">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
        ...
        {/* Department Leaders rankings (65% width) */}
        <div className="lg:col-span-3 bg-white p-6 border border-slate-200/40 rounded-[22px] shadow-sm flex flex-col justify-between">
          <div className="border-b border-slate-100 pb-3 mb-4 flex items-center justify-between">
            ...
            {/* Table headers that sit outside the viewport headers */}
        ...
        {/* Right Sidebar: Insights + Resource Allocation (35% width) */}
        <div className="lg:col-span-2 flex flex-col justify-between space-y-5">
          ...
          <div className="bg-white p-5 border border-slate-200/40 rounded-[22px] shadow-sm flex flex-col justify-between">
            <div className="flex items-center space-x-2 pb-3 mb-1 border-b border-slate-50">
              <svg className="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22" />
              </svg>
              <span className="text-[10px] font-black text-slate-400 tracking-wider">INSIGHTS</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start justify-between space-x-2.5">
                <div className="flex items-start space-x-2.5">
                  <div className="w-6.5 h-6.5 rounded-lg bg-emerald-50 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div className="flex flex-col min-w-0">
                    <span className="text-xs font-bold text-slate-850 leading-tight">Payroll department leads in savings</span>
                    <span className="text-[9.5px] text-slate-400 mt-1 leading-none">Generating 23% of total annual savings</span>
                  </div>
                </div>
                <span className="text-[8.5px] font-bold bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded-full whitespace-nowrap">Top Performer</span>
              </div>

              {/* Item 2 */}
              <div className="flex items-start justify-between space-x-2.5">
                <div className="flex items-start space-x-2.5">
                  <div className="w-6.5 h-6.5 rounded-lg bg-purple-50 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3.5 h-3.5 text-purple-650" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21" />
                    </svg>
                  </div>
                  <div className="flex flex-col min-w-0">
                    <span className="text-xs font-bold text-slate-850 leading-tight">Automation scaling up</span>
                    <span className="text-[9.5px] text-slate-400 mt-1 leading-none">148 robots added this quarter</span>
                  </div>
                </div>
                <span className="text-[8.5px] font-bold bg-purple-50 text-purple-700 px-2 py-0.5 rounded-full whitespace-nowrap">Growing</span>
              </div>

              {/* Item 3 */}
              <div className="flex items-start justify-between space-x-2.5">
                <div className="flex items-start space-x-2.5">
                  <div className="w-6.5 h-6.5 rounded-lg bg-amber-50 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3.5 h-3.5 text-amber-600" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01" />
                    </svg>
                  </div>
                  <div className="flex flex-col min-w-0">
                    <span className="text-xs font-bold text-slate-850 leading-tight">ROI exceeding targets</span>
                    <span className="text-[9.5px] text-slate-400 mt-1 leading-none">6 departments above 170% ROI</span>
                  </div>
                </div>
                <span className="text-[8.5px] font-bold bg-amber-50 text-amber-700 px-2 py-0.5 rounded-full whitespace-nowrap">On Track</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-5 border border-slate-200/40 rounded-[22px] shadow-sm flex flex-col justify-between">
            <div className="flex items-center justify-between pb-3 mb-1 border-b border-slate-50">
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479" />
                </svg>
                <span className="text-[10px] font-black text-slate-400 tracking-wider">RESOURCE ALLOCATION</span>
              </div>
            ...
            <div className="flex items-center justify-between my-1">
              ...
              <div className="flex flex-col space-y-1 text-[9px] font-bold text-slate-500 pl-4 w-3/5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-slate-400">8330.4 FTEs <span className="font-bold text-slate-600 pl-1.5">28%</span></span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-blue-500 mr-1.5" />Audit</span>
                  <span className="font-mono text-slate-400">7821.6 FTEs <span className="font-bold text-slate-600 pl-1.5">22%</span></span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-purple-500 mr-1.5" />Claims Proc</span>
                  <span className="font-mono text-slate-400">6120.8 FTEs <span className="font-bold text-slate-600 pl-1.5">16%</span></span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-sky-200 mr-1.5" />Healthcare</span>
                  <span className="font-mono text-slate-400">5432.6 FTEs <span className="font-bold text-slate-600 pl-1.5">14%</span></span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-amber-500 mr-1.5" />Sales & Mkt</span>
                  <span className="font-mono text-slate-400">4830.2 FTEs <span className="font-bold text-slate-600 pl-1.5">12%</span></span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-slate-300 mr-1.5" />Others</span>
                  <span className="font-mono text-slate-400">2623.4 FTEs <span className="font-bold text-slate-600 pl-1.5">8%</span></span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Row 4: Bottom Miniature Cards Layout (Horizontal Row) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {/* Sub-Card 1 */}
        <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-sm flex items-center space-x-3.5">
          <div className="w-9 h-9 rounded-xl bg-emerald-50 flex items-center justify-center flex-shrink-0 border border-emerald-100/50">
            <svg className="w-4.5 h-4.5 text-emerald-600" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
          <div className="flex flex-col">
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Automation Rate</span>
            <span className="text-base font-black text-slate-800 font-mono mt-0.5 leading-none">68%</span>
            <span className="text-[8px] font-bold text-emerald-600 mt-1 leading-none">▲ 6.2% vs last year</span>
          </div>
        </div>

        {/* Sub-Card 2 */}
        <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-sm flex items-center space-x-3.5">
          <div className="w-9 h-9 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0 border border-blue-100/50">
          ...
          <div className="flex flex-col">
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Avg. Project Duration</span>
            <span className="text-base font-black text-slate-800 font-mono mt-0.5 leading-none">23 Days</span>
            <span className="text-[8px] font-bold text-emerald-600 mt-1 leading-none">▼ 2 days vs last year</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-sm flex items-center space-x-3.5">
          <div className="w-9 h-9 rounded-xl bg-purple-50 flex items-center justify-center flex-shrink-0 border border-purple-100/50">
            <svg className="w-4.5 h-4.5 text-purple-650" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
            </svg>
          </div>
          <div className="flex flex-col">
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Transactions Automated</span>
            <span className="text-base font-black text-slate-800 font-mono mt-0.5 leading-none">2.4B</span>
            <span className="text-[8px] font-bold text-emerald-600 mt-1 leading-none">▲ 12.8% vs last year</span>
          </div>
        </div>

        {/* Sub-Card 4 */}
        <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-sm flex items-center space-x-3.5">
          <div className="w-9 h-9 rounded-xl bg-amber-50 flex items-center justify-center flex-shrink-0 border border-amber-100/50">
            <svg className="w-4.5 h-4.5 text-amber-600" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-base font-black text-slate-800 font-mono mt-0.5 leading-none">98.6%</span>
            <span className="text-[8px] font-bold text-emerald-600 mt-1 leading-none">▲ 1.3% vs last year</span>
          </div>
        </div>
      </div>
