...
export const ControlBar: React.FC<ControlBarProps> = React.memo(({
  ...
  return (
    <div className="flex items-center justify-between px-3 md:px-6 h-[56px] bg-white border-b border-slate-200/80 z-10 font-sans flex-shrink-0 select-none">
      
      {/* Mobile Hamburger Toggle */}
      <button
        onClick={toggleSidebar}
        className="lg:hidden mr-3 p-2 rounded-md text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-colors focus:outline-none"
      >
      ...
      <div className="flex-1 max-w-md relative hidden sm:block">
        ...
        />
        <span className="absolute inset-y-0 right-0 hidden md:flex items-center pr-3 pointer-events-none">
      ...
      <div className="flex items-center space-x-2 md:space-x-2.5 ml-auto sm:ml-6">

        {/* Date Range Pill */}
        <button className="hidden lg:flex items-center space-x-2 px-3 py-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-[11px] font-semibold text-slate-600 transition-all shadow-sm">
        ...
        <button className="hidden lg:flex items-center px-2.5 py-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-[11px] font-semibold text-slate-600 shadow-sm transition-all">
          Last 30 days
        ...
        <div className={`flex items-center px-2.5 py-1.5 rounded-full text-[10px] font-bold border transition-colors flex-shrink-0 ${
          ...
          <span className={`w-1.5 h-1.5 rounded-full ${isPaused ? 'bg-[#ADFF41]' : 'bg-emerald-500 blink-indicator'} sm:mr-1.5`} />
          <span className="uppercase tracking-wider font-mono hidden sm:inline">
            {isPaused 
        ...
        {/* Settings cog icon */}
        <button className="hidden md:flex w-8 h-8 items-center justify-center rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-slate-500 hover:text-slate-700 transition-all shadow-sm">
