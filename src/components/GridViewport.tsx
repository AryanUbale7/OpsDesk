    ...
    <div className="flex-1 flex flex-row overflow-hidden w-full h-full relative font-sans">
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-0 flex-shrink-0">
        ...
        <div className="flex items-center">
          <button className="flex items-center px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-xs font-semibold text-slate-600 hover:bg-slate-50 transition-colors">
        ...
        <div className="flex items-center">
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-3 py-1.5 w-56 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-700 placeholder-slate-400 focus:outline-none focus:border-[#014D3E]/40 transition-colors"
            />
          </div>
        </div>
      </div>
      ...
      {isPaused && (
        <div className="bg-amber-50 dark:bg-amber-950/20 border-b border-amber-100 dark:border-amber-900/30 px-5 py-2.5 flex items-center justify-between text-xs text-amber-800 dark:text-amber-300 font-medium select-none flex-shrink-0">
