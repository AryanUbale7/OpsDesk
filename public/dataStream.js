/**
 * ============================================================================
 * OFFICIAL HACKATHON TELEMETRY PIPELINE ENGINE (dataStream.js) - Adapted
 * ============================================================================
 */
    ...
    for (let i = 1; i < lines.length; i++) {
      ...
      if (values.length === headers.length) {
        ...
        headers.forEach((header, index) => {
          ...
          if (['robots_deployed', 'annual_savings_usd', 'employee_hours_saved', 'budget_usd'].includes(header)) {
      ...
      setInterval(() => {
        ...
        for (let i = 0; i < batchSize; i++) {
          ...
          if (isAnomaly) {
            ...
            row.robots_deployed += Math.floor(randomRange(-5, 5));
            row.roi_percent = parseFloat((row.roi_percent + randomRange(-10, 10)).toFixed(2));
          } else {
            ...
            row.employee_hours_saved += Math.floor(randomRange(-5, 10));
          }
          ...
          row.roi_percent = parseFloat(Math.max(0, row.roi_percent).toFixed(2));
